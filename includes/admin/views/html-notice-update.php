...
<div id="message" class="updated woocommerce-message wc-connect">
	...
	<p class="submit"><a href="<?php echo add_query_arg( 'do_update_wc_charter', 'true', admin_url('admin.php?page=wc-extend-plugin-name-settings') ); ?>" class="wc-extend-plugin-name-update-now button-primary"><?php _e( 'Run the updater', 'wc_charter' ); ?></a></p>
</div>
